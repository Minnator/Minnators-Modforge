...
public static class GlobalEventHandlers
{
   ...
   {
      OnRegionChanged.Invoke(id, new(value, oldValue, propertyName));
   }
   ...
   {
      OnSuperRegionChanged.Invoke(id, new(value, oldValue, propertyName));
   }
   ...
   {
      OnAreaChanged.Invoke(id, new(value, oldValue, propertyName));
   }
