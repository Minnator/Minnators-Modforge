...
public static class ProvinceParser
{
 ...
 ProvinceActionsAndProperties = new()
 {
     ...
     { "add_claim",                          (Add<Tag>,                    Province.Empty.GetPropertyInfo(nameof(Province.ScenarioClaims))!) },
     ...
     { "remove_claim",                       (Remove<Tag>,                 Province.Empty.GetPropertyInfo(nameof(Province.ScenarioClaims))!) },
     { "remove_core",                        (Remove<Tag>,                 Province.Empty.GetPropertyInfo(nameof(Province.ScenarioCores))!) },
     { "remove_discovered_by",               (Remove<string>,              Province.Empty.GetPropertyInfo(nameof(Province.ScenarioDiscoveredBy))!) },
     { "remove_permanent_claim",             (Remove<Tag>,                 Province.Empty.GetPropertyInfo(nameof(Province.ScenarioPermanentClaims))!) },
