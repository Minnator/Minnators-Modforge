namespace Editor.Forms.Feature
{
   partial class ToolTipCustomizer
   {
      ...
      private void InitializeComponent()
      {
         ...
         tableLayoutPanel1.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 33.3333321F));
         tableLayoutPanel1.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 33.3333321F));
         tableLayoutPanel1.Controls.Add(ShowAttributes, 0, 2);
         ...
         tableLayoutPanel1.Controls.Add(AttributeListBox, 2, 0);
         ...
         tableLayoutPanel1.Size = new Size(809, 247);
         tableLayoutPanel1.TabIndex = 0;
         tableLayoutPanel1.Paint += tableLayoutPanel1_Paint;
         // 
         // ShowAttributes
         // 
         ShowAttributes.Anchor = AnchorStyles.None;
         ShowAttributes.Location = new Point(90, 216);
         ShowAttributes.Margin = new Padding(4, 3, 4, 3);
         ShowAttributes.Name = "ShowAttributes";
         ShowAttributes.Size = new Size(88, 27);
         ShowAttributes.TabIndex = 9;
         ShowAttributes.Text = "Show Attributes";
         toolTip1.SetToolTip(ShowAttributes, "Save and apply the changes");
         ShowAttributes.UseVisualStyleBackColor = true;
         ShowAttributes.Click += ShowAttributes_Click;
         // 
         // ToolTipPreview
         // 
         ...
         tableLayoutPanel2.Location = new Point(269, 181);
         tableLayoutPanel2.Margin = new Padding(0);
         tableLayoutPanel2.Name = "tableLayoutPanel2";
         tableLayoutPanel2.RowCount = 1;
         tableLayoutPanel2.RowStyles.Add(new RowStyle(SizeType.Percent, 100F));
         tableLayoutPanel2.Size = new Size(269, 31);
         ...
         RemoveButton.Location = new Point(71, 3);
         RemoveButton.Margin = new Padding(4, 3, 4, 3);
         RemoveButton.Name = "RemoveButton";
         RemoveButton.Size = new Size(59, 25);
         ...
         MoveDownButton.Location = new Point(205, 3);
         MoveDownButton.Margin = new Padding(4, 3, 4, 3);
         MoveDownButton.Name = "MoveDownButton";
         MoveDownButton.Size = new Size(60, 25);
         ...
         MoveUpButton.Location = new Point(138, 3);
         MoveUpButton.Margin = new Padding(4, 3, 4, 3);
         MoveUpButton.Name = "MoveUpButton";
         MoveUpButton.Size = new Size(59, 25);
         ...
         // CancelButton
         // 
         CancelButton.Location = new Point(273, 215);
         ...
         InputTextBox.Size = new Size(261, 23);
         ...
         ConfirmButton.Location = new Point(717, 215);
         ...
         // AttributeListBox
         // 
         AttributeListBox.Dock = DockStyle.Fill;
         AttributeListBox.FormattingEnabled = true;
         AttributeListBox.ItemHeight = 15;
         AttributeListBox.Location = new Point(541, 3);
         AttributeListBox.Name = "AttributeListBox";
         tableLayoutPanel1.SetRowSpan(AttributeListBox, 2);
         AttributeListBox.Size = new Size(265, 206);
         AttributeListBox.Sorted = true;
         AttributeListBox.TabIndex = 10;
         AttributeListBox.MouseDoubleClick += AttributeListBox_MouseDoubleClick;
         // 
         // ToolTipCustomizer
         // 
         AutoScaleDimensions = new SizeF(7F, 15F);
         AutoScaleMode = AutoScaleMode.Font;
         ClientSize = new Size(809, 247);
