...
namespace Editor.Forms
{
   public partial class MapWindow : Form
   {
      ...
      private PrvHistSetAddUi<bool> _prvHistIsCityCheckBox = null!;
      private PrvHistSetAddUi<bool> _prvHistIsHreCheckBox = null!;
      private PrvHistSetAddUi<bool> _prvHistIsParliamentSeatCheckbox = null!;
      ...
      private void InitializeProvinceHistoryGui()
      {
         ...
         _prvHistDevastationNumeric = ControlFactory.GetPrvHistFloatUi(nameof(Province.Devastation),
                                                                       ...
                                                                       value => new AddDevastationEffect() { _value = { Val = value } },
                                                                       hasSet: false);
         _prvHistAutonomyNumeric = ControlFactory.GetPrvHistFloatUi(nameof(Province.Autonomy),
                                                                    typeof(Province).GetProperty(nameof(Province.Autonomy))!,
         ...
         _prvHistCores = ControlFactory.GetPrvHistCollectionUi<List<Country>, Country>(Country.Empty,
                                                                                       ...
                                                                                       Globals.Countries.Values.ToList(), false);
         ...
         _prvHistDiscoveredBy = ControlFactory.GetPrvHistCollectionUi<List<string>, string>(string.Empty,
                                                                                           ...
                                                                                           value => new DiscoveredByEffect { _value = { Val = value } },
                                                                                           [.. Globals.Countries.Keys.Select(x => x.TagValue).ToList(), .. Globals.TechnologyGroups.Keys], false);
